...
| `scripts/` | `plot_style.py` (shared LaTeX figure style), `pxparse.py`, `01_build_ministry_panel.py`, `02_analysis.py`, `03_plots.py`, `04_tables.py`, `05_registry.py`, `06_poll_watchlist.py`, `07_exam_coding.py`, `08_ehu_history.py`, `09_shape_locus.py`, `10_reference_frames.py`, `11_analysis_path.py`, `12_conditional_top.py` |
| `plots/` | Nineteen figures, PNG (200 dpi) and SVG, all matplotlib with LaTeX-typeset text |
...
python3 scripts/01_build_ministry_panel.py && python3 scripts/02_analysis.py && python3 scripts/03_plots.py \
  ...
  && python3 scripts/11_analysis_path.py && python3 scripts/12_conditional_top.py \
