...
| `sources/pisa/` | INEE PISA data tables, chapter 2 of the Spanish reports for 2018 and 2022 (science proficiency levels by community) |
...
python3 scripts/01_build_ministry_panel.py && python3 scripts/02_analysis.py && python3 scripts/03_plots.py \
  ...
  && python3 scripts/13_cohort_drift.py && python3 scripts/15_pisa_link.py && python3 scripts/16_slope_compare.py \
