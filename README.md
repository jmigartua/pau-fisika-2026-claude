...
| `scripts/` | `plot_style.py` (shared LaTeX figure style), `pxparse.py`, `01_build_ministry_panel.py`, `02_analysis.py`, `03_plots.py`, `04_tables.py`, `05_registry.py`, `06_poll_watchlist.py`, `07_exam_coding.py`, `08_ehu_history.py`, `09_shape_locus.py`, `10_reference_frames.py`, `11_analysis_path.py`, `12_conditional_top.py`, `13_cohort_drift.py`, `14_take_up.py`, `15_pisa_link.py`, `16_slope_compare.py`, `17_pau2027_estimator.py`, `18_reading_load.py`, `19_audit_checks.py` (audit tests), `20_build_onepage.py` (single-page edition), `21_decay_decomposition.py` (decay decomposition), `22_subject_decomposition.py` (Euskadi-common vs Física-specific, severity signature), `23_comparability.py` (structural criteria, reform intensity), `24_cohort_rate.py` (PISA steps, selection transfer, 2027), `25_statement_budget.py` (statement length item by item, the 2027 word budget), `26_penalty_regime.py` (non-award vs deduction, the marking-regime simulation), `27_penalty_shape.py` (how the penalties are spread across candidates; `--replot` redraws its figure from the saved JSON), `28_marking_exposure.py` (which sub-items can attract a deduction, the capped linguistic channel, and what the statement growth is made of) |
...
python3 scripts/01_build_ministry_panel.py && python3 scripts/02_analysis.py && python3 scripts/03_plots.py \
  ...
  && python3 scripts/13_cohort_drift.py && python3 scripts/15_pisa_link.py && python3 scripts/16_slope_compare.py && python3 scripts/17_pau2027_estimator.py && python3 scripts/18_reading_load.py && python3 scripts/19_audit_checks.py && python3 scripts/21_decay_decomposition.py && python3 scripts/22_subject_decomposition.py \
  && python3 scripts/23_comparability.py && python3 scripts/24_cohort_rate.py \
  && python3 scripts/25_statement_budget.py && python3 scripts/26_penalty_regime.py \
  && python3 scripts/27_penalty_shape.py && python3 scripts/28_marking_exposure.py \
