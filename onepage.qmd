...
No published aggregate separates H1c from H1b — both are properties of one paper in one year and both displace the whole distribution. But unlike its rivals H1c predicts *where* the marks went: the loss should concentrate in the sub-tasks examining what had never been set as a problem — modern physics beyond the photoelectric effect, standing waves, mirrors, decibels. The competing hypotheses predict no topic pattern at all, so sub-item marks would separate them.
