...
**H1b — "It is the competency model as the EHU implemented it."** *First-order candidate, and the strongest surviving explanation of 2026.* H1a fails because the frame was national and the outcomes were not. That is an argument against the frame, not against the model: what a community did with the frame is a different variable, and it is one the papers themselves record. The content audit of the 2025 and 2026 papers of the nine reporting communities ([The papers themselves](#sec-ch11)) yields a reform-intensity index from four axes that move independently — optionality withdrawn, competency marks, substantive context, contextualised marks. Euskadi scores $+1.76$ and is first of the nine; the next community, Castilla-La Mancha, is at $+0.39$, and the other seven are at or below zero. Five of the six communities that rose in 2026 carry **negative** indices: Asturias $-0.19$, Madrid $-0.44$, Cataluña $-0.72$, Comunitat Valenciana $-0.71$, Andalucía $-0.45$; the exception is Castilla-La Mancha at $+0.39$, which added one obligatory contextualised item and rose $+0.94$. Across the nine, $r = -0.70$, $p = 0.035$. The reading this supports is narrower than a dose-response: drop Euskadi and the correlation falls to $r = -0.40$, $p = 0.33$, so the relation *is* Euskadi. Euskadi moved from one competency exercise to half the marks, halved its optionality and changed format at once — the only paper in the set that changed genre between the two years — and it is the only one that did. H1b therefore records one community implementing the frame completely and alone, which is exactly what makes it a candidate and exactly what stops the nine-community panel from testing it.
