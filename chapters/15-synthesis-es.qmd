...
::: {.column-margin}
**De dónde salen esos «normalmente».** De un *lugar geométrico*: una curva ajustada sobre las 187 observaciones comunidad-año del panel que da la proporción de cada banda en función de la media. Evaluada en la media de 2023 y en la de 2024, la diferencia es lo que una distribución corriente habría hecho al bajar 0.21.
...
::: {.column-margin}
**Dos rangos, no uno.** Sobre el residuo condicional, 2024 es el **2.º de 170**. Sobre el tamaño combinado de los dos desajustes respecto del lugar geométrico, es el **11.º de 170**. Las dos medidas son razonables y este documento da las dos.

**Por qué 170 y no 187.** Diecisiete comunidades dan once años de datos — 187 observaciones — pero solo diez pasos de un año al siguiente: $17 \times 10 = 170$.

Fuente: `typology.pais_vasco.2024`, en `decomposition.json`, calculado por `21_decay_decomposition.py` (rutas completas en el cap. 10).
:::
