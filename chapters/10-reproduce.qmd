...
All sixteen figures are matplotlib, generated by `scripts/03_plots.py` (1–10), `scripts/07_exam_coding.py` (11–12), `scripts/08_ehu_history.py` (13–15) and `scripts/09_shape_locus.py` (16) from the CSVs in `data/` and `data/analysis/`, and written to `plots/` as PNG (200 dpi, or 170 dpi for 11–15) and SVG under the exact filenames the chapters include. Nothing in the site is a hand-drawn or externally sourced image.
