...
Nothing in the analysis depends on privileged access. Every paper used is public and archived under `sources/exams/`; every figure is regenerated from those files by a script in `scripts/`; the word counts that carry the argument can be reproduced by anyone with the PDFs. Where the author's own knowledge is used rather than the documents, as in the paragraph above, it is stated as such.
