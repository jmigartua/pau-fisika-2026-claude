...
| H1b No el modelo — **esta conversión, a esta velocidad** | Candidata de primer orden; la explicación de 2026 que mejor se sostiene | Reescrita sobre el archivo catalán: Cataluña examina con contextos reales y exigencias de justificación todos los años desde 2020 y no se hundió; reducir a la mitad sus marcas competenciales en 2026 no movió su posición frente al conjunto. El marco era nacional; la implementación, no. En un índice de intensidad de reforma construido sobre cuatro ejes independientes (optatividad retirada, marcas competenciales, contexto sustantivo, marcas contextualizadas) Euskadi es la primera de las nueve con $+1.76$, y la siguiente comunidad está en $+0.39$. Cinco de las seis comunidades que *subieron* tienen índices negativos; sobre las nueve, $r = -0.70$, $p = 0.035$, que cae a $r = -0.40$, $p = 0.33$ sin Euskadi — la relación *es* Euskadi. Una sola comunidad implementó el marco por completo, y sola. |
| H1c Quince años de una prueba previsible, y dos cursos para reajustar | Plausible, no medida, no separable de H1b — y la única candidata que predice un patrón por temas | Durante quince años el 40 % de la nota salió de una lista cerrada; solo se pusieron 22 títulos en 120 huecos; la optatividad fue del 100 %. Catorce de quince problemas de física moderna fueron fotoeléctricos, y fisión y fusión solo eran títulos de teoría, hasta que 2026 las puso como problema. La prueba había sido el temario. A los centros se les dijo — anuncio en 2024, con 2024-25 y 2025-26 declarados de transición —, de modo que esto va de práctica, no de información: un anuncio no crea bancos de ejemplos, simulacros ni soltura docente. Cataluña no tenía ese equilibrio que deshacer. A diferencia de las demás, predice un patrón por temas, que las notas por subapartado contrastarían. |
...
: Ordenación: H1b y H2 juntas en cabeza, no separables sobre agregados publicados; H1c plausible detrás de ellas; H3 sin resolver y contrastable; H5 como fondo; H1a como coincidencia de 2025; H4 no sostenida dentro de la PAU; H6 no sostenida [cap. 6]. {#tbl-e-hyp tbl-colwidths="[24,14,62]"}
...
![**a** — la serie vasca con dos escenarios para 2027; la barra es el término interanual, no un intervalo de predicción. **b** — el único término de cohorte estimado frente a la dispersión a través de la cual hay que leerlo, y frente a lo que 2026 hizo realmente.](../plots/fig23_pau2027_es.png){#fig-e-2027}
