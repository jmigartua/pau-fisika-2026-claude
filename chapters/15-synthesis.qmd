...
**What the field cannot be asked to carry.** Drawn as routes rather than as a scatter — each community an arrow from the competency-coded share of its 2025 paper to that of its 2026 paper, against the change in its mean — **six of the nine have no horizontal component at all**: no competency-coded marks in either year. Their outcomes nevertheless span $-0.83$ to $+1.13$, a range of **1.96 marks**. Whatever moved them was not conversion, because they did none, and that spread is a ceiling on how much of 2026 any account resting on conversion alone can claim ([Ch. 11](11-exam-content.qmd#competency-path)).

**And the reopened syllabus was avoidable.** The 2026 syllabus was reopened, but that says what *could* be set, not what a candidate had to answer. Mapped slot by slot against sixteen years of precedent, both 2026 slots carrying **no optionality** were on sub-topics ranked first (set 18 times) and eleventh (set 5 times) in the archive, while every genuinely novel item — carbon-14 dating, plutonium-239 decay — sat opposite a familiar alternative. A candidate prepared exactly as the previous fifteen years rewarded could have declined all of it. Content novelty is therefore very nearly excluded for the ordinary sitting, which relocates H1c: not unfamiliar physics, but preparation diluted across a wider syllabus and familiar physics in an unfamiliar form ([Ch. 12](12-ehu-paper-history.qmd)).

**What an outside conversion cost.** Fifteen Catalan papers 2005–2019 were added and one mechanical rule applied from 2010: the traditional decade sits at **17.7 %** of items demanding justification and 2020–2023 at **50.0 %** — a step at 2020, five years before the decree. Against the fifteen-community field, Cataluña moves $+0.42$ (2015–19) to $-0.43$ (2022–25), a shift of $-0.85$ with $p = 0.09$, exact $p = 0.12$, and **a minimum detectable shift of 1.26** — a bound, not a coefficient, of which 59 % is the field rising rather than Cataluña falling. Two things carry. A conversion of that size produced nothing detectable over six years, while Euskadi's second year alone is $-1.65$. And Cataluña's *lowest* traditional year is 6.2 %: it never examined without asking anyone to justify anything, where the Basque paper carried zero competency marks as late as 2024. It changed once and left the paper alone for five years; Euskadi changed four axes in two sittings ([Ch. 11](11-exam-content.qmd#catalunya-event)).

**The panel has memory, and 2027 will spend it.** Asked whether the Catalan curve is cyclic, the answer is no — a difference against the field cannot hold a driver common to Spain, eleven points hold one cycle, and fitting the same cosine to all fifteen communities puts **Aragón ahead of Cataluña** with periods running 2.5 to 40 years. What the wave is instead is mean reversion: within a community the deviation follows an AR(1) with $\phi = 0.186$, which predicts that year-to-year changes anticorrelate at $-0.407$ against $-0.389$ observed. That has a consequence. Euskadi's 2026 deviation from its own norm is $-2.16$; a **shock** predicts $-0.40$ in 2027 (95 % $[-1.32, +0.52]$), a **level change** predicts $-2.16$ ($[-3.08, -1.24]$) — 3.7 $\sigma$ apart, settled by one sitting. **If the paper is changed and the mean recovers by about a mark and a half, that is what doing nothing predicts** ([Ch. 6](06-interpretation.qmd#mean-reversion)).
