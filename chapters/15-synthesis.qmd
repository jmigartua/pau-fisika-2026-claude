...
**And the arithmetic the target implies.** A competency item, in the two Basque papers that have one, costs 350 to 400 words: A1 was 403 in 2025, and the two of 2026 are 289 and 406, a mean of 348. The four optional items of 2026 average 184. The 2027 budget is 972 words over six statements, and those three numbers do not fit: if the options stay at 184, the two competency items get 118 words each; even bringing the options down to 150 leaves them 186. **The target requires cutting the competency items by 40 to 55 per cent**, from about 350 words to under 200, on precisely the two items that carry the demand the reform introduced. That is why the three rules that change the *architecture* of a competency item — scaffold once, criteria into the rubric, draw the set-up — matter more than the two that trim prose.
