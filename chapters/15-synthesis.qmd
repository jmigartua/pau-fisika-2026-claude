...
::: {.column-margin}
**Where those "normally"s come from.** From a *locus*: a curve fitted across all 187 community-year observations in the panel, giving each band's share as a function of the mean. Evaluated at the 2023 mean and at the 2024 mean, the difference is what an ordinary distribution would have done on a fall of 0.21.
...
::: {.column-margin}
**Two ranks, not one.** On the conditional residual, 2024 is **2nd of 170**. On the combined size of the two departures from the locus, it is **11th of 170**. Both measures are reasonable and this document gives both.

**Why 170 and not 187.** Seventeen communities give eleven years of data — 187 observations — but only ten steps from one year to the next: $17 \times 10 = 170$.

Source: `typology.pais_vasco.2024`, in `decomposition.json`, computed by `21_decay_decomposition.py` (full paths in ch. 10).
:::
