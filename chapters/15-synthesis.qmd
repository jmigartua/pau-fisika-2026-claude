...
![**a** — each item's statement in 2025 and 2026 against the 2027 target band; the obligatory competency items are in red. **b** — the two reconstructions of the 2026 electromagnetic problem, which share only their endpoint. **c** — what the paper costs to read and to answer, and what the target would cost.](../plots/fig29_statement_budget.png){#fig-s-budget .column-page}
